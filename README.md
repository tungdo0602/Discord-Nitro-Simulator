# UPDATE!!!!
# WORKED AGAIN THANKS @steinhorror FOR THE webpack fix (his github: https://github.com/steinhorror) and also can use animated emoji correctly (some server have NQN bot, dm not working)
